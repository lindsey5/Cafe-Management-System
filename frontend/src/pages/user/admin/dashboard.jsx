...
const SalesToday = lazy(() => import('../../../ui/admin/dashboard/SalesToday'));
const TotalCashiers = lazy(() => import('../../../ui/admin/dashboard/TotalCashiers'));
const SalesThisYear = lazy(() => import('../../../ui/admin/dashboard/SalesThisYear'));
...
const MonthlySales = () => {
    ...
    useEffect(() => {
        const fetchMonthlySales = async () => {
            const response = await fetchData('/api/sale/month'); 
            if(response.success){
